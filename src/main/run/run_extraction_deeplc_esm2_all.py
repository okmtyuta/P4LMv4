#!/usr/bin/env python3
"""
esm2用の全Extraction configをManagerで順次実行するスクリプト
（動的探索は用いず、明示importで収集）
"""

from src.main.configs.extraction.deeplc.esm2 import (
    arabidopsis_config,
...
def main() -> None:
    print(f"Found {len(ALL_CONFIGS)} configs under deeplc.esm2")
